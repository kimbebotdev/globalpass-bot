...
# Base URL used for download links (set ENVIRONMENT=prod to switch)
...
GF_LEG_ROW = "div[jsname='MOPQS'] > div"
...
GF_RETURN_INPUT = "input[aria-label*='Return' i], input[placeholder*='Return' i]"
